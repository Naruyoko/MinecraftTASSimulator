...
public class MinecraftTASEditorGui extends Gui {
    ...
    public void render(RenderGameOverlayEvent.Post event) {
        ...
        if (MinecraftTASEditorEditor.isSelectingTick()) {
            ...
            drawLine(MinecraftTASEditorUtil.stringifyKeys(input),inputColor);
            drawLine("+(IJKLU)",0xffffff);
            drawLine(MinecraftTASEditorUtil.stringifyMouse(input,8),inputColor);
        ...
        if (selectedTick==-1) {
            ...
            drawRightAlignedLine("Initial game mode: "+MinecraftTASEditorUtil.stringifyGameType(MinecraftTASEditorEditor.getStartGametype()),0xffffff);
        }
    }
}
