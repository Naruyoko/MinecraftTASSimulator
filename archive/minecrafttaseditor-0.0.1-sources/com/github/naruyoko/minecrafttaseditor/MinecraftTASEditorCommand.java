...
public class MinecraftTASEditorCommand extends CommandBase {
    ...
    public void func_71515_b(ICommandSender sender,String[] args) throws CommandException {
        ...
        if (args==null||args.length==0) {
            ...
            MinecraftTASEditorInput input=MinecraftTASEditorEditor.getSelectedInput();
            input.setRotationYaw(rotationPitch);
            MinecraftTASEditorEditor.setSelectedInput(input);
    ...
    public List<String> func_180525_a(ICommandSender sender,String[] args,BlockPos pos) {
        ...
        if (args.length<=2) return func_71530_a(args,"start","stop","save","load","reinitsim","selecttick","warpto","setstartpos","setstartmotion","setstartinvulnerabilityframes","setstartgametype","setrotationyaw","setrotationpitch","setrotationexact","toggleinheriteffectsfromallticks","togglegui","detail");
        return null;
    }
    @Override
