...
public class MinecraftTASEditorEditor {
    ...
    private static void calculateAccurateInputs() {
        final float ROTATION_PER_PIXEL=0.15F;
            ...
            if (input==null) {
                ...
                if (input.isRotationExact()) {
                    ...
                    if (yawDiff>MAX_SAFE_YAW) {
                        lastRotationYaw+=ROTATION_PER_PIXEL*MAX_SAFE_YAW;
                    ...
                    if (yawDiff!=0||pitchDiff!=0) {
                        lastRotationYaw+=ROTATION_PER_PIXEL*yawDiff;
                        lastRotationPitch+=ROTATION_PER_PIXEL*pitchDiff;
                    }
