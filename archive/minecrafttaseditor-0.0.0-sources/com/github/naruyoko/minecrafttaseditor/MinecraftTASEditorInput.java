...
public class MinecraftTASEditorInput {
    ...
    public MinecraftTASEditorInput(boolean keyForward,boolean keyLeft,boolean keyBackward,boolean keyRight,boolean keyJump,boolean keySneak,boolean keySprint,double rotationYaw,double rotationPitch) {
    ...
    public MinecraftTASEditorInput() {
        this(false,false,false,false,false,false,false,0,0);
    }
    @Override
    public MinecraftTASEditorInput clone() {
        return new MinecraftTASEditorInput(keyForward,keyLeft,keyBackward,keyRight,keyJump,keySneak,keySprint,rotationYaw,rotationPitch);
    }
